...
docker tag docker-php-upgrade:cli-8.0.25 sync402/docker-php-upgrade:cli-8.0.25
docker push sync402/docker-php-upgrade:cli-8.0.25
docker rmi sync402/docker-php-upgrade:cli-8.0.25
docker tag docker-php-upgrade:cli-8.0.25 sync402/docker-php-upgrade:cli-8.0
...
docker tag docker-php-upgrade:cli-pure-8.0.25 sync402/docker-php-upgrade:cli-pure-8.0.25
docker push sync402/docker-php-upgrade:cli-pure-8.0.25
docker rmi sync402/docker-php-upgrade:cli-pure-8.0.25
docker tag docker-php-upgrade:cli-pure-8.0.25 sync402/docker-php-upgrade:cli-pure-8.0
...
docker tag docker-php-upgrade:cli-swoole-8.0.25 sync402/docker-php-upgrade:cli-swoole-8.0.25
docker push sync402/docker-php-upgrade:cli-swoole-8.0.25
docker rmi sync402/docker-php-upgrade:cli-swoole-8.0.25
docker tag docker-php-upgrade:cli-swoole-8.0.25 sync402/docker-php-upgrade:cli-swoole-8.0
...
docker tag docker-php-upgrade:fpm-8.0.25 sync402/docker-php-upgrade:fpm-8.0.25
docker push sync402/docker-php-upgrade:fpm-8.0.25
docker rmi sync402/docker-php-upgrade:fpm-8.0.25
docker tag docker-php-upgrade:fpm-8.0.25 sync402/docker-php-upgrade:fpm-8.0
...
docker tag docker-php-upgrade:fpm-pure-8.0.25 sync402/docker-php-upgrade:fpm-pure-8.0.25
docker push sync402/docker-php-upgrade:fpm-pure-8.0.25
docker rmi sync402/docker-php-upgrade:fpm-pure-8.0.25
docker tag docker-php-upgrade:fpm-pure-8.0.25 sync402/docker-php-upgrade:fpm-pure-8.0
...
docker tag docker-php-upgrade:nginx-8.0.25 sync402/docker-php-upgrade:nginx-8.0.25
docker push sync402/docker-php-upgrade:nginx-8.0.25
docker rmi sync402/docker-php-upgrade:nginx-8.0.25
docker tag docker-php-upgrade:nginx-8.0.25 sync402/docker-php-upgrade:nginx-8.0
...
docker tag docker-php-upgrade:nginx-pure-8.0.25 sync402/docker-php-upgrade:nginx-pure-8.0.25
docker push sync402/docker-php-upgrade:nginx-pure-8.0.25
docker rmi sync402/docker-php-upgrade:nginx-pure-8.0.25
docker tag docker-php-upgrade:nginx-pure-8.0.25 sync402/docker-php-upgrade:nginx-pure-8.0
...
docker tag docker-php-upgrade:octane-8.0.25 sync402/docker-php-upgrade:octane-8.0.25
docker push sync402/docker-php-upgrade:octane-8.0.25
docker rmi sync402/docker-php-upgrade:octane-8.0.25
docker tag docker-php-upgrade:octane-8.0.25 sync402/docker-php-upgrade:octane-8.0
...
docker tag docker-php-upgrade:octane-pure-8.0.25 sync402/docker-php-upgrade:octane-pure-8.0.25
docker push sync402/docker-php-upgrade:octane-pure-8.0.25
docker rmi sync402/docker-php-upgrade:octane-pure-8.0.25
docker tag docker-php-upgrade:octane-pure-8.0.25 sync402/docker-php-upgrade:octane-pure-8.0
