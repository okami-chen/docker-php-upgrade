...
docker build -f 7.4/fpm-centos/Dockerfile -t sync402/docker-php:fpm-centos-7.4.33 .
docker push sync402/docker-php:fpm-centos-7.4.33
docker rmi sync402/docker-php:fpm-centos-7.4
docker tag sync402/docker-php:fpm-centos-7.4.33 sync402/docker-php:fpm-centos-7.4
docker push sync402/docker-php:fpm-centos-7.4

docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.4.33
docker tag sync402/docker-php:fpm-centos-7.4.33 registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.4.33
docker push registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.4.33
docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.4.33

docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.4
docker tag sync402/docker-php:fpm-centos-7.4.33 registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.4
docker push registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.4
docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.4
