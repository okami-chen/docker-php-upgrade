...
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-7.4 sync402/docker-php-upgrade:cli-7.4.33
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-7.4 sync402/docker-php-upgrade:cli-7.4
...
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-7.4 sync402/docker-php-upgrade:fpm-7.4.33
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-7.4 sync402/docker-php-upgrade:fpm-7.4
