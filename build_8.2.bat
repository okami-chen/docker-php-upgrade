...
docker build -f 8.2/cli-pure/Dockerfile -t docker-php-upgrade:cli-pure-8.2 .
docker tag docker-php-upgrade:cli-pure-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-pure-8.2
docker tag docker-php-upgrade:cli-pure-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-pure-8.2.0RC6
...
docker tag docker-php-upgrade:cli-pure-8.2 sync402/docker-php-upgrade:cli-pure-8.2
docker tag docker-php-upgrade:cli-pure-8.2 sync402/docker-php-upgrade:cli-pure-8.2.0RC6
...
docker build -f 8.2/cli-swoole/Dockerfile -t docker-php-upgrade:cli-swoole-8.2 .
docker tag docker-php-upgrade:cli-swoole-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-swoole-8.2
docker tag docker-php-upgrade:cli-swoole-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-swoole-8.2.0RC6
...
docker tag docker-php-upgrade:cli-swoole-8.2 sync402/docker-php-upgrade:cli-swoole-8.2
docker tag docker-php-upgrade:cli-swoole-8.2 sync402/docker-php-upgrade:cli-swoole-8.2.0RC6
...
docker build -f 8.2/fpm-pure/Dockerfile -t docker-php-upgrade:fpm-pure-8.2 .
docker tag docker-php-upgrade:fpm-pure-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-pure-8.2
docker tag docker-php-upgrade:fpm-pure-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-pure-8.2.0RC6
...
docker tag docker-php-upgrade:fpm-pure-8.2 sync402/docker-php-upgrade:fpm-pure-8.2
docker tag docker-php-upgrade:fpm-pure-8.2 sync402/docker-php-upgrade:fpm-pure-8.2.0RC6
...
docker build -f 8.2/nginx-pure/Dockerfile -t docker-php-upgrade:nginx-pure-8.2 .
docker tag docker-php-upgrade:nginx-pure-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:nginx-pure-8.2
docker tag docker-php-upgrade:nginx-pure-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:nginx-pure-8.2.0RC6
...
docker tag docker-php-upgrade:nginx-pure-8.2 sync402/docker-php-upgrade:nginx-pure-8.2
docker tag docker-php-upgrade:nginx-pure-8.2 sync402/docker-php-upgrade:nginx-pure-8.2.0RC6
...
docker build -f 8.2/octane-pure/Dockerfile -t docker-php-upgrade:octane-pure-8.2 .
docker tag docker-php-upgrade:octane-pure-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:octane-pure-8.2
docker tag docker-php-upgrade:octane-pure-8.2 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:octane-pure-8.2.0RC6
...
docker tag docker-php-upgrade:octane-pure-8.2 sync402/docker-php-upgrade:octane-pure-8.2
docker tag docker-php-upgrade:octane-pure-8.2 sync402/docker-php-upgrade:octane-pure-8.2.0RC6
