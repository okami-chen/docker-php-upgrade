...
docker build -f Dockerfile-8.2-fpm -t sync402/docker-php:fpm-8.2.0 .
...
docker rmi sync402/docker-php:fpm-8.2.0

docker build -f Dockerfile-8.2-nginx -t sync402/docker-php:nginx-8.2.0 .
...
docker rmi sync402/docker-php:nginx-8.2.0
