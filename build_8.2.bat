...
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-8.2 sync402/docker-php-upgrade:cli-8.2.0RC6
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-8.2 sync402/docker-php-upgrade:cli-8.2
...
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-8.2 sync402/docker-php-upgrade:fpm-8.2.0RC6
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-8.2 sync402/docker-php-upgrade:fpm-8.2
