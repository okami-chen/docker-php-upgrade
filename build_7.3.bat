...
@REM 版本[cli-mongo]构建
docker build -f 7.3/cli-mongo/Dockerfile -t sync402/docker-php:cli-mongo-7.3.24 .
docker push sync402/docker-php:cli-mongo-7.3.24
docker rmi sync402/docker-php:cli-mongo-7.3
docker tag sync402/docker-php:cli-mongo-7.3.24 sync402/docker-php:cli-mongo-7.3
docker push sync402/docker-php:cli-mongo-7.3

docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:cli-mongo-7.3.24
docker tag sync402/docker-php:cli-mongo-7.3.24 registry.cn-shanghai.aliyuncs.com/okami/docker-php:cli-mongo-7.3.24
docker push registry.cn-shanghai.aliyuncs.com/okami/docker-php:cli-mongo-7.3.24
docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:cli-mongo-7.3.24

docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:cli-mongo-7.3
docker tag sync402/docker-php:cli-mongo-7.3.24 registry.cn-shanghai.aliyuncs.com/okami/docker-php:cli-mongo-7.3
docker push registry.cn-shanghai.aliyuncs.com/okami/docker-php:cli-mongo-7.3
docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:cli-mongo-7.3
