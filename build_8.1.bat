...
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-8.1 sync402/docker-php-upgrade:cli-8.1.12
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-8.1 sync402/docker-php-upgrade:cli-8.1
...
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-8.1 sync402/docker-php-upgrade:fpm-8.1.12
docker tag registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-8.1 sync402/docker-php-upgrade:fpm-8.1
