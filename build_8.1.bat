...
docker build -f 8.1/cli-pure/Dockerfile -t docker-php-upgrade:cli-pure-8.1 .
docker tag docker-php-upgrade:cli-pure-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-pure-8.1
docker tag docker-php-upgrade:cli-pure-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-pure-8.1.12
...
docker tag docker-php-upgrade:cli-pure-8.1 sync402/docker-php-upgrade:cli-pure-8.1
docker tag docker-php-upgrade:cli-pure-8.1 sync402/docker-php-upgrade:cli-pure-8.1.12
...
docker build -f 8.1/cli-swoole/Dockerfile -t docker-php-upgrade:cli-swoole-8.1 .
docker tag docker-php-upgrade:cli-swoole-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-swoole-8.1
docker tag docker-php-upgrade:cli-swoole-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:cli-swoole-8.1.12
...
docker tag docker-php-upgrade:cli-swoole-8.1 sync402/docker-php-upgrade:cli-swoole-8.1
docker tag docker-php-upgrade:cli-swoole-8.1 sync402/docker-php-upgrade:cli-swoole-8.1.12
...
docker build -f 8.1/fpm-pure/Dockerfile -t docker-php-upgrade:fpm-pure-8.1 .
docker tag docker-php-upgrade:fpm-pure-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-pure-8.1
docker tag docker-php-upgrade:fpm-pure-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:fpm-pure-8.1.12
...
docker tag docker-php-upgrade:fpm-pure-8.1 sync402/docker-php-upgrade:fpm-pure-8.1
docker tag docker-php-upgrade:fpm-pure-8.1 sync402/docker-php-upgrade:fpm-pure-8.1.12
...
docker build -f 8.1/nginx-pure/Dockerfile -t docker-php-upgrade:nginx-pure-8.1 .
docker tag docker-php-upgrade:nginx-pure-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:nginx-pure-8.1
docker tag docker-php-upgrade:nginx-pure-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:nginx-pure-8.1.12
...
docker tag docker-php-upgrade:nginx-pure-8.1 sync402/docker-php-upgrade:nginx-pure-8.1
docker tag docker-php-upgrade:nginx-pure-8.1 sync402/docker-php-upgrade:nginx-pure-8.1.12
...
docker build -f 8.1/octane-pure/Dockerfile -t docker-php-upgrade:octane-pure-8.1 .
docker tag docker-php-upgrade:octane-pure-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:octane-pure-8.1
docker tag docker-php-upgrade:octane-pure-8.1 registry.cn-shanghai.aliyuncs.com/okami/docker-php-upgrade:octane-pure-8.1.12
...
docker tag docker-php-upgrade:octane-pure-8.1 sync402/docker-php-upgrade:octane-pure-8.1
docker tag docker-php-upgrade:octane-pure-8.1 sync402/docker-php-upgrade:octane-pure-8.1.12
