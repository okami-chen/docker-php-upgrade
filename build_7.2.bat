...
docker build -f 7.2/fpm-centos/Dockerfile -t sync402/docker-php:fpm-centos-7.2.34 .
docker push sync402/docker-php:fpm-centos-7.2.34
docker rmi sync402/docker-php:fpm-centos-7.2
docker tag sync402/docker-php:fpm-centos-7.2.34 sync402/docker-php:fpm-centos-7.2
docker push sync402/docker-php:fpm-centos-7.2

docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.2.34
docker tag sync402/docker-php:fpm-centos-7.2.34 registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.2.34
docker push registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.2.34
docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.2.34

docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.2
docker tag sync402/docker-php:fpm-centos-7.2.34 registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.2
docker push registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.2
docker rmi registry.cn-shanghai.aliyuncs.com/okami/docker-php:fpm-centos-7.2
